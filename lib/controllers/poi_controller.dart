...
class PoiController {
  ...
  Future<List<Marker>> markersForView(
    ...
    final out = <Marker>[];
    IconData _ico(String k)=>k=='park'?Icons.local_parking:k=='fuel'?Icons.local_gas_station:k=='svc'?Icons.build:Icons.camera_alt;
    Future<void> add(String table,String key) async {
      final rows = await db!.inBBox(table: table, west: w, south: s, east: e, north: n, limit: 300);
